...
public class RemoveSpreadsheetBlankColumnsRequest : IRequestOption
{
    public RemoveSpreadsheetBlankColumnsRequest(FileParameter spreadsheet)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/remove/blank-columns";
