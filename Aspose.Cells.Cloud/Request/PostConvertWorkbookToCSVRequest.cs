...
/// <summary>Convert Excel file to Csv files.</summary>
public class PostConvertWorkbookToCSVRequest : IRequestOption
{
    public PostConvertWorkbookToCSVRequest(FileParameter file)
    {
