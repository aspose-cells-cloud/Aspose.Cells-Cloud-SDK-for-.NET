...
public class PostMergeRequest : IRequestOption
{
    public PostMergeRequest(FileParameter file)
    {
    ...
    public Dictionary<string, string> GetQueryParameters()
    {
        ...
        if (MergeToOneSheet.HasValue) query["mergeToOneSheet"] = MergeToOneSheet.Value ? "true" : "false";
