...
/// <summary>Convert Excel file to Pptx files.</summary>
public class PostConvertWorkbookToPptxRequest : IRequestOption
{
    public PostConvertWorkbookToPptxRequest(FileParameter file)
    {
