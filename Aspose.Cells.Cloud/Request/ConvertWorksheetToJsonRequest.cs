...
/// <summary>Converts a worksheet of spreadsheet on a local drive to the JSON file.</summary>
public class ConvertWorksheetToJsonRequest : IRequestOption
{
    public ConvertWorksheetToJsonRequest(FileParameter spreadsheet, string worksheet)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/convert/worksheet/json";
