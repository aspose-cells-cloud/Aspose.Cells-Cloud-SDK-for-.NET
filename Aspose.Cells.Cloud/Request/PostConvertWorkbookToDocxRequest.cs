...
/// <summary>Convert Excel file to Docx files.</summary>
public class PostConvertWorkbookToDocxRequest : IRequestOption
{
    public PostConvertWorkbookToDocxRequest(FileParameter file)
    {
