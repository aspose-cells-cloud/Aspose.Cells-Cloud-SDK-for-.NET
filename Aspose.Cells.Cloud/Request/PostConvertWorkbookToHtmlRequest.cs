...
/// <summary>Convert Excel file to HTML files.</summary>
public class PostConvertWorkbookToHtmlRequest : IRequestOption
{
    public PostConvertWorkbookToHtmlRequest(FileParameter file)
    {
