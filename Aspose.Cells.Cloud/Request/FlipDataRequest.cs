...
/// <summary>Transposes a specified data range (rows become columns, columns become rows).</summary>
public class FlipDataRequest : IRequestOption
{
    public FlipDataRequest(FileParameter spreadsheet, string worksheet, string cellArea)
    {
    ...
    public Dictionary<string, string> GetQueryParameters()
    {
        ...
        if (Horizontal.HasValue) query["Horizontal"] = Horizontal.Value ? "true" : "false";
