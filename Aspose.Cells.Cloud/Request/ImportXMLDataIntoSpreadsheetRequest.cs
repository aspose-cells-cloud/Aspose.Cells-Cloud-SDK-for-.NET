...
/// <summary>Import XML data file into the local spreadsheet.</summary>
public class ImportXMLDataIntoSpreadsheetRequest : IRequestOption
{
    public ImportXMLDataIntoSpreadsheetRequest(FileParameter datafile, FileParameter spreadsheet, string worksheet, string startcell)
    {
