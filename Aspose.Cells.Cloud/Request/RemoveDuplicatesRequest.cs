...
/// <summary>Removes duplicate values in the worksheet/range/table.</summary>
public class RemoveDuplicatesRequest : IRequestOption
{
    public RemoveDuplicatesRequest(FileParameter spreadsheet)
    {
    ...
    public Dictionary<string, string> GetQueryParameters()
    {
        ...
        if (!string.IsNullOrEmpty(Table)) query["table"] = Table;
