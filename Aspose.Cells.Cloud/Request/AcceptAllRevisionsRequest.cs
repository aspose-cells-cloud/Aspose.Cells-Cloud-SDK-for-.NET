...
/// <summary>AcceptAllRevisions operation.</summary>
public class AcceptAllRevisionsRequest : IRequestOption
{
    public AcceptAllRevisionsRequest(FileParameter spreadsheet)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/spreadsheet/accept-all-revisions";
