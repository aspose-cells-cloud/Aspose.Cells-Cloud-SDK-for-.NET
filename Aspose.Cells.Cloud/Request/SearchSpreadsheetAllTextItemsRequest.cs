...
public class SearchSpreadsheetAllTextItemsRequest : IRequestOption
{
    public SearchSpreadsheetAllTextItemsRequest(FileParameter spreadsheet)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/search/content/all-textitems";
