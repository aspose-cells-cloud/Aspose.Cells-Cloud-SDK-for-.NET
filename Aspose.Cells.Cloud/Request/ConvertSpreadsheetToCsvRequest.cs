...
/// <summary>Converts a spreadsheet on a local drive to the csv file.</summary>
public class ConvertSpreadsheetToCsvRequest : IRequestOption
{
    public ConvertSpreadsheetToCsvRequest(FileParameter spreadsheet)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/convert/spreadsheet/csv";
