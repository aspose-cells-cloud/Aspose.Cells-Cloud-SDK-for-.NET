...
/// <summary>Remove a date filter in the worksheet.</summary>
public class DeleteWorksheetDateFilterRequest : IRequestOption
{
    public DeleteWorksheetDateFilterRequest(string name, string sheetName, int fieldIndex, string dateTimeGroupingType)
    {
