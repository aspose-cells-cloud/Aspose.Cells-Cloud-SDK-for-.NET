...
/// <summary>Convert Excel file to SQL Script files.</summary>
public class PostConvertWorkbookToSQLRequest : IRequestOption
{
    public PostConvertWorkbookToSQLRequest(FileParameter file)
    {
