...
/// <summary>Update style in the PivotTable.</summary>
public class PostPivotTableStyleRequest : IRequestOption
{
    public PostPivotTableStyleRequest(string name, string sheetName, int pivotTableIndex, Style style)
    {
