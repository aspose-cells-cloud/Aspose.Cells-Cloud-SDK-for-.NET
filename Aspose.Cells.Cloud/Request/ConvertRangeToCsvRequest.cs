...
/// <summary>Converts a range of spreadsheet on a local drive to the csv file.</summary>
public class ConvertRangeToCsvRequest : IRequestOption
{
    public ConvertRangeToCsvRequest(FileParameter spreadsheet, string worksheet, string range)
    {
