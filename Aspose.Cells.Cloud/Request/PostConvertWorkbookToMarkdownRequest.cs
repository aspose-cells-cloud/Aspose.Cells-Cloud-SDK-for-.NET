...
/// <summary>Convert Excel file to Markdown files.</summary>
public class PostConvertWorkbookToMarkdownRequest : IRequestOption
{
    public PostConvertWorkbookToMarkdownRequest(FileParameter file)
    {
