...
/// <summary>Add a format condition in the worksheet.</summary>
public class PutWorksheetFormatConditionRequest : IRequestOption
{
    public PutWorksheetFormatConditionRequest(string name, string sheetName, int index, string cellArea, string type, string operatorType, string formula1, string formula2)
    {
