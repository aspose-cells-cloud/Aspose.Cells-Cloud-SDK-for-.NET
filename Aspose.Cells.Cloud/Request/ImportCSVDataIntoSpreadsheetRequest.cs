...
/// <summary>Import CSV data file into the local spreadsheet.</summary>
public class ImportCSVDataIntoSpreadsheetRequest : IRequestOption
{
    public ImportCSVDataIntoSpreadsheetRequest(FileParameter datafile, FileParameter spreadsheet, string worksheet, string startcell)
    {
