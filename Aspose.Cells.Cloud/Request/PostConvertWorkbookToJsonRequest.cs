...
/// <summary>Convert Excel file to Json files.</summary>
public class PostConvertWorkbookToJsonRequest : IRequestOption
{
    public PostConvertWorkbookToJsonRequest(FileParameter file)
    {
