...
/// <summary>Converts a spreadsheet on a local drive to the JSON file.</summary>
public class ConvertSpreadsheetToJsonRequest : IRequestOption
{
    public ConvertSpreadsheetToJsonRequest(FileParameter spreadsheet)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/convert/spreadsheet/json";
