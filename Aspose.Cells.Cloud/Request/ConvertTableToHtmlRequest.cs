...
/// <summary>Converts a table of spreadsheet on a local drive to the html file.</summary>
public class ConvertTableToHtmlRequest : IRequestOption
{
    public ConvertTableToHtmlRequest(FileParameter spreadsheet, string worksheet, string tableName)
    {
