...
/// <summary>Convert Excel file to PDF files.</summary>
public class PostConvertWorkbookToPDFRequest : IRequestOption
{
    public PostConvertWorkbookToPDFRequest(FileParameter file)
    {
