...
/// <summary>Delete cells document properties in Excel file, and save them is various formats.</summary>
public class DeleteMetadataRequest : IRequestOption
{
    public DeleteMetadataRequest(FileParameter file)
    {
