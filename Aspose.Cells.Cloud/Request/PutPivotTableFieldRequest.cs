...
/// <summary>Add a pivot field in the PivotTable.</summary>
public class PutPivotTableFieldRequest : IRequestOption
{
    public PutPivotTableFieldRequest(string name, string sheetName, int pivotTableIndex, string pivotFieldType, PivotTableFieldRequest pivotTableFieldRequest)
    {
