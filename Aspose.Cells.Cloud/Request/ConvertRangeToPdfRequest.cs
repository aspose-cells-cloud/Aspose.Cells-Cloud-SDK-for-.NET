...
/// <summary>Converts a range of spreadsheet on a local drive to the pdf file.</summary>
public class ConvertRangeToPdfRequest : IRequestOption
{
    public ConvertRangeToPdfRequest(FileParameter spreadsheet, string worksheet, string range)
    {
