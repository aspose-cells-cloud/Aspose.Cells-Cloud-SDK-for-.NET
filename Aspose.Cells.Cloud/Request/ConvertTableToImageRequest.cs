...
/// <summary>Converts a table of spreadsheet on a local drive to the image file.</summary>
public class ConvertTableToImageRequest : IRequestOption
{
    public ConvertTableToImageRequest(FileParameter spreadsheet, string worksheet, string tableName, string format)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/convert/table/image";
