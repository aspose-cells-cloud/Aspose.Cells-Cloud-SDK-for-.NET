...
/// <summary>Set the style for the specified range.</summary>
public class PostWorksheetCellsRangeStyleRequest : IRequestOption
{
    ...
    public RangeSetStyleRequest RangeOperate { get; }
