...
/// <summary>Applies dual-layer password protection to Excel spreadsheets, supporting both open and modify passwords with encryption.</summary>
public class ProtectSpreadsheetRequest : IRequestOption
{
    public ProtectSpreadsheetRequest(FileParameter spreadsheet, string password, string modifyPassword)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/protection/spreadsheet";
