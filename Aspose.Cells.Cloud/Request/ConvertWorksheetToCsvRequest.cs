...
/// <summary>Converts a worksheet of spreadsheet on a local drive to the CSV file.</summary>
public class ConvertWorksheetToCsvRequest : IRequestOption
{
    public ConvertWorksheetToCsvRequest(FileParameter spreadsheet, string worksheet)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/convert/worksheet/csv";
