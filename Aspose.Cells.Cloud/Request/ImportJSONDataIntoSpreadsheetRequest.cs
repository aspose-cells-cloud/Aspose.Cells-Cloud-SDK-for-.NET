...
/// <summary>Import JSON data file into the local spreadsheet.</summary>
public class ImportJSONDataIntoSpreadsheetRequest : IRequestOption
{
    public ImportJSONDataIntoSpreadsheetRequest(FileParameter datafile, FileParameter spreadsheet, string worksheet, string startcell)
    {
