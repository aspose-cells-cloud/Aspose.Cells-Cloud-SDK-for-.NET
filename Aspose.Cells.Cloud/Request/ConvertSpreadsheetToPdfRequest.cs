...
/// <summary>Converts a spreadsheet on a local drive to the pdf file.</summary>
public class ConvertSpreadsheetToPdfRequest : IRequestOption
{
    public ConvertSpreadsheetToPdfRequest(FileParameter spreadsheet)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/convert/spreadsheet/pdf";
