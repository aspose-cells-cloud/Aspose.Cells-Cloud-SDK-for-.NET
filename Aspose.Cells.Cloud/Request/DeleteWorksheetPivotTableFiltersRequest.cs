...
/// <summary>Delete all pivot filters in the PivotTable.</summary>
public class DeleteWorksheetPivotTableFiltersRequest : IRequestOption
{
    public DeleteWorksheetPivotTableFiltersRequest(string name, string sheetName, int pivotTableIndex)
    {
