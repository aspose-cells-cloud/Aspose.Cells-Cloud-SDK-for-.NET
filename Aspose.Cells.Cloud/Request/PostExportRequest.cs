...
public class PostExportRequest : IRequestOption
{
    public PostExportRequest(FileParameter file)
    {
    ...
    public Dictionary<string, string> GetQueryParameters()
    {
        ...
        if (!string.IsNullOrEmpty(ObjectType)) query["objectType"] = ObjectType;
