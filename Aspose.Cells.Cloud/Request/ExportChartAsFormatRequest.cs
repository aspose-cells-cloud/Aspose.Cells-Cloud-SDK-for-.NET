...
/// <summary>Converts a chart of spreadsheet in cloud storage to the specified format.</summary>
public class ExportChartAsFormatRequest : IRequestOption
{
    public ExportChartAsFormatRequest(string name, string worksheet, int chartIndex, string format)
    {
