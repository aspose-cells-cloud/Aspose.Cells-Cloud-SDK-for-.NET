...
/// <summary>Update pivot fields in the PivotTable.</summary>
public class PostPivotTableUpdatePivotFieldsRequest : IRequestOption
{
    public PostPivotTableUpdatePivotFieldsRequest(string name, string sheetName, int pivotTableIndex, string pivotFieldType, PivotField pivotField)
    {
