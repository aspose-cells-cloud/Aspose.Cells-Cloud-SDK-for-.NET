...
/// <summary>Converts a worksheet of spreadsheet on a local drive to the html file.</summary>
public class ConvertWorksheetToHtmlRequest : IRequestOption
{
    public ConvertWorksheetToHtmlRequest(FileParameter spreadsheet, string worksheet)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/convert/worksheet/html";
