...
/// <summary>Converts a table of spreadsheet on a local drive to the pdf file.</summary>
public class ConvertTableToPdfRequest : IRequestOption
{
    public ConvertTableToPdfRequest(FileParameter spreadsheet, string worksheet, string tableName)
    {
