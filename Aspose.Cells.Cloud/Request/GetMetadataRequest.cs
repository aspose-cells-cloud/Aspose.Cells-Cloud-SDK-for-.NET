...
/// <summary>Get cells document properties.</summary>
public class GetMetadataRequest : IRequestOption
{
    public GetMetadataRequest(FileParameter file)
    {
