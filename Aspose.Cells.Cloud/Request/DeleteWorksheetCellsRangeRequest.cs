...
/// <summary>Delete a range of cells and shift existing cells based on the specified shift option.</summary>
public class DeleteWorksheetCellsRangeRequest : IRequestOption
{
