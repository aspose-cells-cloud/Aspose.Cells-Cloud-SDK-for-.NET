...
/// <summary>Converts a range of spreadsheet on a local drive to the json file.</summary>
public class ConvertRangeToJsonRequest : IRequestOption
{
    public ConvertRangeToJsonRequest(FileParameter spreadsheet, string worksheet, string range)
    {
