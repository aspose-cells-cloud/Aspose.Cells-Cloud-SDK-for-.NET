...
/// <summary>Delete all blank rows that do not contain any data or other objects.</summary>
public class RemoveSpreadsheetBlankWorksheetsRequest : IRequestOption
{
    public RemoveSpreadsheetBlankWorksheetsRequest(FileParameter spreadsheet)
    {
    ...
    public string GetPath() =>
        "/v4.0/cells/remove/blank-worksheets";
