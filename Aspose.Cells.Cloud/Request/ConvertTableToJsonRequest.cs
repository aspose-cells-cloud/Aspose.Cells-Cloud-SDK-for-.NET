...
/// <summary>Converts a table of spreadsheet on a local drive to the json file.</summary>
public class ConvertTableToJsonRequest : IRequestOption
{
    public ConvertTableToJsonRequest(FileParameter spreadsheet, string worksheet, string tableName)
    {
