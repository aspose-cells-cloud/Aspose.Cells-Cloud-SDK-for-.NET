...
/// <summary>Rotate rows, columns, or other objects in Excel files and save them in various formats.</summary>
public class PostRotateRequest : IRequestOption
{
    public PostRotateRequest(FileParameter file, string rotateType)
    {
